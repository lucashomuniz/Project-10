...
# Passo 3: Treinar o modelo de Random Forest Regressor
...
print(f"\nErro Médio Absoluto (MAE) - Random Forest: {mae_rf:.2f} toneladas")
print(f"Raiz do Erro Quadrático Médio (RMSE) - Random Forest: {rmse_rf:.2f} toneladas")
print(f"Coeficiente de Determinação (R²) - XGBoost: {r2_rf:.4f}")

# Passo 4: Prever as vendas para o Q4 de 2018
# Codificar as combinações de Q4 de 2018 para usar no modelo de previsão
...
y_pred_2018_rf = model_rf.predict(X_pred_2018)

# Exibir o total previsto para Q4 de 2018
print(f"Previsão de vendas para o Q4 de 2018 (Random Forest): {y_pred_2018_rf.sum():.2f} toneladas")